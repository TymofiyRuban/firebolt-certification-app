...
type AdConfigurationOptions = {
  ...
  */
  function advertisingId(options?: AdvertisingIdOptions): Promise<AdvertisingIdResult>
...
type AuthenticationTokenResult = {
  ...
  */
  function token(type: TokenType, options?: object): Promise<AuthenticationTokenResult>
...
/**
 ...
 For devices that do not require additional connections (e.g. panels), `true` will be returned for all profiles.
   * 
   */
function hdcp(subscriber: (negotiatedHdcpVersions: HDCPVersionMap) => void): Promise<number>
...
/**
   ...
   * 
   */
function hdr(subscriber: (negotiatedHdrFormats: HDRFormatMap) => void): Promise<number>
...
/**
   ...
   * 
   */
function network(subscriber: (networkInfo: NetworkInfoResult) => void): Promise<number>
...
function once(event: 'deviceNameChanged', callback: (data: string) => void): Promise<number>
 ...
 For devices that do not require additional connections (e.g. panels), `true` will be returned for all profiles.
   ...
   * @param {Function} callback
  */
  function listen(event: 'hdcpChanged', callback: (data: HDCPVersionMap) => void): Promise<number>
 ...
 For devices that do not require additional connections (e.g. panels), `true` will be returned for all profiles.
   ...
   * @param {Function} callback
  */
function once(event: 'hdcpChanged', callback: (data: HDCPVersionMap) => void): Promise<number>
   ...
   * @param {Function} callback
  */
  function listen(event: 'hdrChanged', callback: (data: HDRFormatMap) => void): Promise<number>
   ...
   * @param {Function} callback
  */
function once(event: 'hdrChanged', callback: (data: HDRFormatMap) => void): Promise<number>
...
function once(event: 'nameChanged', callback: (data: string) => void): Promise<number>
   ...
   * @param {Function} callback
  */
  function listen(event: 'networkChanged', callback: (data: NetworkInfoResult) => void): Promise<number>
   ...
   * @param {Function} callback
  */
function once(event: 'networkChanged', callback: (data: NetworkInfoResult) => void): Promise<number>
...
**Deprecated:** Use non-Firebolt APIs specific to your platform, e.g. W3C APIs
  ...
  */
  function listen(event: 'screenResolutionChanged', callback: (data: Resolution) => void): Promise<number>
...
**Deprecated:** Use non-Firebolt APIs specific to your platform, e.g. W3C APIs
   ...
   * @deprecated since version 1.4.0
  */
function once(event: 'screenResolutionChanged', callback: (data: Resolution) => void): Promise<number>
...
4K Ultra High Definition (UHD): [3840, 2160]
   ...
   * @param {Function} callback
  */
  function listen(event: 'videoResolutionChanged', callback: (data: Resolution) => void): Promise<number>
...
4K Ultra High Definition (UHD): [3840, 2160]
   ...
   * @param {Function} callback
  */
function once(event: 'videoResolutionChanged', callback: (data: Resolution) => void): Promise<number>
...
**Deprecated:** Use non-Firebolt APIs specific to your platform, e.g. W3C APIs
   * 
   */
function screenResolution(subscriber: (screenResolution: Resolution) => void): Promise<number>
...
4K Ultra High Definition (UHD): [3840, 2160]
   * 
   */
function videoResolution(subscriber: (videoResolution: Resolution) => void): Promise<number>
...
type TVSeriesEntity = {
     ...
     * 
     */
type PlayableEntity = MovieEntity | TVEpisodeEntity | PlaylistEntity | MusicEntity | AdditionalEntity
...
function purchasedContent(result: PurchasedContentResult): Promise<boolean>
  ...
  */
  function userInterest(type: InterestType, reason: InterestReason, entity: EntityDetails): Promise<null>
...
interface UserInterestProvider {
    userInterest(parameters: UserInterestProviderParameters, session: ProviderSession): Promise<EntityDetails>

}


function provide(capability: 'xrn:firebolt:capability:discovery:interest', provider: UserInterestProvider | object): Promise<void>
